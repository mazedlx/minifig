...
class MinifigsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        App\Minifig::create([
            'set_id' => 2,
            'name' => 'Luke Skywalker (Stormtrooper Outfit)'
        ]);
        App\Minifig::create([
            'set_id' => 2,
            'name' => 'Han Solo (Stormtrooper Outfit)'
        ]);
        App\Minifig::create([
            'set_id' => 2,
        ...
        App\Minifig::create([
            'set_id' => 17,
            'name' => 'Geonosian Pilot'
        ]);
        App\Minifig::create([
            'set_id' => 16,
            'name' => 'Darth Maul (Santa)'
        ]);
        App\Minifig::create([
            'set_id' => 16,
        ...
        App\Minifig::create([
            'set_id' => 23,
            'name' => 'Spear Lion Knight'
        ]);
        App\Minifig::create([
            'set_id' => 23,
            'name' => 'Crossbow Lion Knight'
        ]);
        App\Minifig::create([
            'set_id' => 23,
            'name' => 'Wizard'
